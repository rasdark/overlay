...
SRC_URI="http://vsftpd.devnet.ru/files/3.0.2/ext.1/vsFTPd-3.0.2-ext1.tgz"
S="${WORKDIR}/vsFTPd-3.0.2-ext.1"
...
src_prepare() {
	...
	if ! use caps ; then
		einfo "Can't compile this vsftpd extention package without caps" && die
