...
EGIT_BRANCH="master"
EGIT_PROJECT="conky"
EGIT_REPO_URI="git://github.com/brndnmtthws/conky.git"
...
#
#	epatch 	"${FILESDIR}/${PN}-1.9.0-ncurses.patch" \
#		"${FILESDIR}/${PN}-1.9.0-lines-fix.patch" \
#		"${FILESDIR}/${PN}-1.9.0-update-when-message-count-decreases.patch"
#}
